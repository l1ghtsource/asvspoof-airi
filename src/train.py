...
def train_hubert(config):
    ...
    config_ = HubertConfig.from_pretrained(pretrained_model)
    ...
    model = HubertForSequenceClassification.from_pretrained(
        pretrained_model, config=config_, ignore_mismatched_sizes=True
    )
    model.init_weights()

    training_args = TrainingArguments(
        output_dir='./runs/hubert_classifier',
